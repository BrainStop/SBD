...
final public class Consola {
	...
	//As minha implementações
	
	//TODO convencionar um adimensão para o numero
	public static Integer getNSerie() {
		String num = null;
		Integer numero = null;
		do {
			Consola.writeLine("Indique o número de série da máquina:");
	...
	//TODO convencionar um adimensão para o numero
	public static Integer getModelo() {
		String num = null;
		Integer numero = null;
		do {
			Consola.writeLine("Indique o número de modelo da máquina:");
			num = Consola.readLine();
			num = num.trim();
			try {
				numero = new Integer(num);
	...
	public static String getPontoDeVenda() {
		String nome = null;
		do {
			Consola.writeLine("Indique o novo Ponto de Venda (max. 10 caracteres):");
			nome = Consola.readLine();
			nome = nome.trim();
		} while (nome.length() > 10 || nome.length() == 0);
		return nome;
	}
	...
	public static String[] getLote() {
		...
		String nome = null;
		do {
			Consola.writeLine("Indique a validade do lote (max. 10 caracteres):");
			nome = Consola.readLine();
			nome = nome.trim();
		} while (nome.length() > 10 || nome.length() == 0);
		resultado[0] = nome;
		do {
			Consola.writeLine("Indique o preço de compra do lote (max. 10 caracteres):");
			nome = Consola.readLine();
			nome = nome.trim();
		} while (nome.length() > 10 || nome.length() == 0);
		resultado[1] = nome;
	...
	public static Integer getFuncionarioID(){
		...
		Integer numero = null;
		do {
			Consola.writeLine("Indique o ID do Funcionario:");
			num = Consola.readLine();
			num = num.trim();
			try {
				numero = new Integer(num);
	...
	public static Integer getQuantidade(){
		...
		Integer numero = null;
		do {
			Consola.writeLine("Indique a quantidade desejada:");
			num = Consola.readLine();
			num = num.trim();
			try {
				numero = new Integer(num);
	...
	public static String getProdutoID() {
		String nome = null;
		do {
			Consola.writeLine("Indique o nome do Produto (max. 10 caracteres):");
			nome = Consola.readLine();
			nome = nome.trim();
		} while (nome.length() > 10 || nome.length() == 0);
		return nome;
	...
	//TODO convencionar um adimensão para o numero
	public static String getViatura() {
		String nome = null;
		do {
			Consola.writeLine("Indique a matricula da Viatura (max. 10 caracteres):");
			nome = Consola.readLine();
			nome = nome.trim();
		} while (nome.length() > 10 || nome.length() == 0);
		return nome;
	...
	//TODO dimensao
	public static Integer getArmazemID(){
		String num = null;
		Integer numero = null;
		do {
			Consola.writeLine("Indique o ID do Armazem:");
			num = Consola.readLine();
			num = num.trim();
			try {
				numero = new Integer(num);
	...
	static private SimpleDateFormat outFormatar = new SimpleDateFormat(
			outFormat);
	static {
		try {
	...
	public static String getCCodDis() {
		...
		do {
			Consola
			.writeLine("Indique o código da disciplina (max. 4 caracteres):");
	...
	public static String getCDsgDis() {
		...
		do {
			Consola
			.writeLine("Indique a nova designação (max. 60 caracteres):");
	 ...
	 * for vazia devolve o caracter espaço.
	 * 
	 ...
	 * 
	 * @param data
	 *            Data no formado fornecido pelo utilizador
	 * @return Calendário
	 * @throws ParseException
	 *             Ocorreu um erro na análise da String data
	 */
	...
	/**
	 * Escreve uma linha do Standar Output
	 * 
	 * @param line
	 *            linha a ser escrita
	 */
